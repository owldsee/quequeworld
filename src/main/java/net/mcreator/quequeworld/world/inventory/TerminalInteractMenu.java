...
public class TerminalInteractMenu extends AbstractContainerMenu {
    private final TerminalBlockEntity blockEntity;
    private final ContainerLevelAccess access;

    public TerminalInteractMenu(int containerId, Inventory playerInventory, RegistryFriendlyByteBuf extraData) {
        this(containerId, playerInventory, getBlockEntity(playerInventory, extraData));
    }

    public TerminalInteractMenu(int containerId, Inventory playerInventory, TerminalBlockEntity blockEntity) {
        super(ModMenus.TERMINAL_INTERACT_MENU.get(), containerId);
